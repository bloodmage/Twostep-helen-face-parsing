...
def dolabel(i):
    print i
    component = misc.imread(os.path.join('labels',i,'%s_lbl08.png'%i))
    ...
    for s in range(20):
        l1=l-random.randrange(h/4,h/2+10)
        r1=r+random.randrange(h/4,h/2+10)
        u1=u-random.randrange(w/4,w/2+10)
        d1=d+random.randrange(w/4,w/2+10)
