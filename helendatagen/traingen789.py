...
def dolabel(i):
    print i
    component = np.maximum(np.maximum(misc.imread(os.path.join('labels',i,'%s_lbl07.png'%i)),misc.imread(os.path.join('labels',i,'%s_lbl08.png'%i))),misc.imread(os.path.join('labels',i,'%s_lbl09.png'%i)))
    ...
    PasteCenter(ExtendCrop(img.open(os.path.join('labels',i,'%s_lbl07.png'%(i))),(l1,u1,r1,d1)),(80,80)).save(r'hardtask%s\%s_07.png'%(lbl,i))
    PasteCenter(ExtendCrop(img.open(os.path.join('labels',i,'%s_lbl08.png'%(i))),(l1,u1,r1,d1)),(80,80)).save(r'hardtask%s\%s_08.png'%(lbl,i))
    PasteCenter(ExtendCrop(img.open(os.path.join('labels',i,'%s_lbl09.png'%(i))),(l1,u1,r1,d1)),(80,80)).save(r'hardtask%s\%s_09.png'%(lbl,i))
    return
    for s in range(20):
        l1=l-random.randrange(h/4,h/2+RNDSIZE)-40
        r1=r+random.randrange(h/4,h/2+RNDSIZE)+40
        u1=u-random.randrange(w/4,w/2+RNDSIZE)-40
        d1=d+random.randrange(w/4,w/2+RNDSIZE)+40
        ...
        PasteCenter(ExtendCrop(img.open(os.path.join('labels',i,'%s_lbl07.png'%(i))),(l1,u1,r1,d1)),(80,80)).rotate(rot,img.BICUBIC,False).save(r'hardtask%s/%s_%s_07.png'%(lbl,i,s))
        PasteCenter(ExtendCrop(img.open(os.path.join('labels',i,'%s_lbl08.png'%(i))),(l1,u1,r1,d1)),(80,80)).rotate(rot,img.BICUBIC,False).save(r'hardtask%s/%s_%s_08.png'%(lbl,i,s))
        PasteCenter(ExtendCrop(img.open(os.path.join('labels',i,'%s_lbl09.png'%(i))),(l1,u1,r1,d1)),(80,80)).rotate(rot,img.BICUBIC,False).save(r'hardtask%s/%s_%s_09.png'%(lbl,i,s))
